            ...
            <div class = "max">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo base_url()?>khoa">Khoa</a></li>
                        <li><a href="<?php echo base_url()?>chuyennganh">Chuyên ngành</a></li>
                    ...
                    <?php if(isset($admin)){
                    ?>
                        <li><a href="<?php echo base_url()?>sinhvien/login"><?php echo $admin ?></a></li>
                        <li><a href="<?php echo base_url()?>sinhvien/logout">Đăng xuất</a></li>
                    <?php
                    }
                    ?>
<!--                        <li class="dropdown">-->
