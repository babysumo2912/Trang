<html>
<head>
    <title>Giáo viên - Trường Đại Học Mỏ Địa Chất</title>
    <meta charset = "utf-8">
        ...
        <div class = "max">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand home" href="<?php echo base_url()?>giaovien"><i class = "fa fa-home"></i></a>
                </div>

                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <!--                    <ul class="nav navbar-nav">-->
                    <!--                        <li class="active"><a href="--><?php //echo base_url()?><!--daotao">Danh sách <span class="sr-only">(current)</span></a></li>-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <?php if(isset($tengiaovien)){
                            ?>
                            <li><a href="<?php echo base_url()?>"><?php echo $tengiaovien ?></a></li>
                            <li><a href="<?php echo base_url()?>giaovien/home/logout">Đăng xuất</a></li>
                            <?php
                        }
                        ?>
                        <!--                        <li class="dropdown">-->
