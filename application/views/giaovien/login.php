...
<section class = "wapper_login">
    ...
    echo form_open('giaovien/home/login',$style);
    ?>
    ...
    <div class = "form-group">
        <div class="input-group">
            ...
            <input class="form-control" name="magiaovien" required="" placeholder="Mã giáo viên" type="text">
        </div>
    </div>
    <div class = "form-group">
        <div class="input-group">
            ...
            <input class="form-control" name="matkhau" required="" placeholder="Mật khẩu" type="password">
        </div>
    </div>
