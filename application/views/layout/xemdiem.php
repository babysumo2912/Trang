        ...
        <div>
            ...
            if($danhsachmonhoc_sinhvien && $danhsachmonhoc_sinhvien!=''){
                ...
                <!-- <div class="text-center">
                    <a href="<?php echo base_url() ?>report/report_sv" class="btn btn-default">In Bảng Điểm</a>
                </div> -->
                <div style="border: 1px white solid; box-shadow: 5px 5px 15px #ccc; padding:20px; margin-bottom: 30px">
                <table class="table table-bordered" style="font-family: times">
                <caption style="font-family: Times; font-size: 18; color: black;">Học kì <?php echo $hk->tenhocki?> Năm học: <?php echo $hk->nambatdau ?> - <?php echo $hk->namketthuc ?></caption>
