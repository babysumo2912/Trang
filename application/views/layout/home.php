    ...
    <div class = "max hd2">
        ...
        <div class = "col-md-4">
            ...
            <div class = "new-right">
                ...
                <ul>
                    <li>
                        <i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp;<a href="" title="Đi lao động Nhật Bản - kiếm tiền lao động hay hưởng thụ">Tin kinh tế vô địch giải bóng đá IT cup</a>
                    </li>
                    <!-- <li>
